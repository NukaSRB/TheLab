...
<script>
  $(document).ready(function ()
  {
    ...
    $.notifyDefaults({
      ...
      template:      '<article data-notify="container" class="col-xs-11 col-sm-3 message is-{0}" role="alert">' +
                     '<div class="message-body">' +
                     '<span data-notify="title">{1}</span> ' +
                     '<button type="button" aria-hidden="true" class="delete" data-notify="dismiss"></button>' +
