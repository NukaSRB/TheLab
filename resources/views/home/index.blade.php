...
<div class="columns">
  <div class="column is-one-quarter is-offset-one-quarter">
    <div class="card is-fullwidth">
      <header class="card-header">
        <p class="card-header-title text-turquoise">
          Front End: Bulma
        </p>
  ...
  <div class="column is-one-quarter">
    <div class="card is-fullwidth">
      <header class="card-header">
        <p class="card-header-title text-vue">
...
<div class="columns">
  <div class="column is-one-quarter is-offset-one-quarter">
    <div class="card is-fullwidth">
      <header class="card-header">
        <p class="card-header-title text-laravel">
          Back End: Laravel 5.3
        </p>
        <a class="card-header-icon">
